...
public sealed class GymChallServiceTests
{
    ...
    public async Task Register_checkin_uses_active_challenge_and_creates_valid_request()
    {
        ...
        await service.RegisterCheckInAsync(new RegisterCheckInRequest(participantId, new DateTimeOffset(2026, 6, 15, 5, 5, 0, TimeSpan.FromHours(-4)), null, participantId, "5am"));
